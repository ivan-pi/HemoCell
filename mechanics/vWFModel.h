...
class vWFModel : public CellMechanics {
  ...
  static double calculate_kBend(Config & cfg) {return 0;}
  static double calculate_kLink(Config & cfg) {return 0;}
  static double calculate_bend_eq(Config & cfg) {return 0;}
  static double calculate_link_eq(Config & cfg) {return 0;}
  static double calculate_etaM(Config & cfg ) {return 0;}
  static double calculate_etaV(Config & cfg ) {return 0;}
